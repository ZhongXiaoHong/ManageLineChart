...
public class SupportMultipleScreensUtil {
    ...
    public static final int BASE_SCREEN_HEIGHT = 1136;
    public static final float BASE_SCREEN_WIDTH_FLOAT = 640F;
    public static final float BASE_SCREEN_HEIGHT_FLOAT = 1136F;
